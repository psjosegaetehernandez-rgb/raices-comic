    ...
    <main className="home">
      ...
      <section className="home__chapters">
        ...
        <ul className="home__chapter-list">
          ...
          <li className="home__chapter-item">
            <Link to="/capitulo/cap4" className="home__chapter-link">
              <span className="home__chapter-num">04</span>
              <div className="home__chapter-info">
                <h3 className="home__chapter-title">El Color del Papel</h3>
                <p className="home__chapter-meta">
                  Yusmary · Santiago de Chile
                </p>
              </div>
              <span className="home__chapter-arrow">→</span>
            </Link>
          ...
          <li className="home__chapter-item">
            <Link to="/capitulo/cap5" className="home__chapter-link">
              <span className="home__chapter-num">05</span>
              <div className="home__chapter-info">
                <h3 className="home__chapter-title">La Escuela del Silencio</h3>
                <p className="home__chapter-meta">
                  Daniel · Escuela pública, Alto Hospicio
                </p>
              </div>
              <span className="home__chapter-arrow">→</span>
            </Link>
